...
function wire(){
 ...
 $("summaryYear").onchange=renderSummary;$("summaryMonth").onchange=renderSummary;$("summaryFilter").oninput=renderSummary;$("holidayYear").onchange=()=>{ensureDefaultHolidays(+$("holidayYear").value);save();renderHolidays()};
